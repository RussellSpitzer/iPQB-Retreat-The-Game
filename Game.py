class ene (object):
	def __init__(self,name,hitpoints,sassy,strength=1):
		self.name=name
...
enemies= [ene("Tryptophan",1,"Not so"),
		  ene("Nukey, The pore Complex",9001,"Extremely"),
		  ene("Troll",10,"Very"),
		  ene("Slime",1,"Don't Go There"),
		  ene("Agonist Gradient",3,"Gradiently"),
		  ene("LiCad",21,"Light Activatedly"),
		  ene("Corona Virus",1e6,"Pandemically",100),
		  ]
